    ...
    <nav className= {`navbar navbar-expand-lg bg-${props.mode}`} data-bs-theme={`${props.mode}`}>
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className={`form-check form-check-inline mx-5 text-${props.mode==='light'?'dark':'light'}`}>
            <input className="form-check-input" onClick={props.showRed} type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"/>
          ...
          <div className={`form-check form-check-inline text-${props.mode==='light'?'dark':'light'}`}>
            <input className="form-check-input" onClick={props.showYellow} type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"/>
